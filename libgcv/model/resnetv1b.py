...
def resnet50_v1d(pretrained=False, root='~/Desktop/Human-Object-Relation-Network-master/.mxnet/models', ctx=cpu(0), name_prefix='resnetv1d_', **kwargs):
...
def resnet101_v1d(pretrained=False, root='~/Desktop/Human-Object-Relation-Network-master/.mxnet/models', ctx=cpu(0), **kwargs):
    """Constructs a ResNetV1d-50 model.
...
def resnet152_v1d(pretrained=False, root='~/Desktop/Human-Object-Relation-Network-master/.mxnet/models', ctx=cpu(0), **kwargs):
    """Constructs a ResNetV1d-50 model.
